# Security Policy for user-risk-detection-api

## Supported Versions

The user-risk-detection-api project provides security updates for the following versions:
...
If you discover a security vulnerability in user-risk-detection-api, we encourage responsible disclosure. To report a vulnerability:
...
We appreciate the security community's efforts in helping us maintain user-risk-detection-api’s safety and integrity.

## Security Practices

user-risk-detection-api follows industry best practices for security to ensure safe transactions and protect user data:

### 1. **Authentication and Authorization**

- user-risk-detection-api uses secure methods for user authentication, including strong password hashing (e.g., bcrypt).
...
Contributors can help enhance user-risk-detection-api's security by following these practices:
...
Thank you for helping us make user-risk-detection-api secure for our users and the community!
